...
<template>
  <div class="library-content">
    <RecycleScroller
      ...
      v-slot="{ item, index }"
    >
      <div class="list-item" :class="{'list-item-playing': songId == item.id, 'unplayable': !unblockEnabled && item.playable === false}" @dblclick="play(item, index)" @contextmenu="openMenu($event,item)">
